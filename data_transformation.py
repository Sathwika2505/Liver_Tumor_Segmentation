...
def transform_data():
    url = visualise_image()
    ALL_CLASSES = ['background', 'livertumor']
    ...
    def get_images(root_path):
        train_images = glob.glob(f"{root_path}/output_images_dir/*")
        #print("===",train_images)
        train_images.sort()
        train_masks = glob.glob(f"{root_path}/output_labels_dir/*")
        train_masks.sort()
        #print("====",train_masks)
        valid_images = glob.glob(f"{root_path}/output_images_dir/*")
        valid_images.sort()
        valid_masks = glob.glob(f"{root_path}/output_labels_dir/*")
        valid_masks.sort()
